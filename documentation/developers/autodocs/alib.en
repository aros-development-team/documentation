...
`FreeTagsFromStack()`_                  `GetDataStreamFromFormat()`_            `GetDTAttrs()`_                         `GetExtSprite()`_                       
`GetMsgFromStack()`_                    `GetParamsFromStack()`_                 `GetRexxVar()`_                         `GetRPAttrs()`_                         
`GetSegListInfoTags()`_                 `GetTagsFromStack()`_                   `GetVisualInfo()`_                      `GT_GetGadgetAttrs()`_                  
`GT_SetGadgetAttrs()`_                  `HookEntry()`_                          `HotKey()`_                             `InvertString()`_                       
`InvertStringForwd()`_                  `LayoutMenuItems()`_                    `LayoutMenus()`_                        `LibAllocAligned()`_                    
`LibAllocPooled()`_                     `LibCreatePool()`_                      `LibDeletePool()`_                      `LibFreePooled()`_                      
`LockBitMapTags()`_                     `MakeWorkbenchObjectVisible()`_         `Merge()`_                              `MergeSortList()`_                      
`NewDTObject()`_                        `NewList()`_                            `NewLoadSegTags()`_                     `NewObject()`_                          
`NewRawDoFmt()`_                        `NewRectRegion()`_                      `ObtainBestPen()`_                      `ObtainInfo()`_                         
`OpenAmigaGuide()`_                     `OpenAmigaGuideAsync()`_                `OpenCatalog()`_                        `OpenScreenTags()`_                     
`OpenWindowTags()`_                     `OpenWorkbenchObject()`_                `RangeRand()`_                          `RefreshDTObject()`_                    
`RefreshDTObjects()`_                   `ReleaseInfo()`_                        `RemoveAmigaGuideHost()`_               `SelectErrorOutput()`_                  
`SendAmigaGuideCmd()`_                  `SendAmigaGuideContext()`_              `SetAmigaGuideAttrs()`_                 `SetAmigaGuideContext()`_               
`SetAttrs()`_                           `SetDTAttrs()`_                         `SetGadgetAttrs()`_                     `SetInfo()`_                            
`SetRexxVar()`_                         `SetRPAttrs()`_                         `SetSuperAttrs()`_                      `SetWindowPointer()`_                   
`StrDup()`_                             `SystemTags()`_                         `TimeDelay()`_                          `UnLockBitMapTags()`_                   
`VideoControlTags()`_                   `WorkbenchControl()`_                   
======================================= ======================================= ======================================= ======================================= 
...
`CreateStdIO()`_ `DeleteExtIO()`_ `DeleteStdIO()`_ 
...
`CreateExtIO()`_ `DeleteExtIO()`_ `DeleteStdIO()`_ 
...
`CreateStdIO()`_ `CreateExtIO()`_ `DeleteStdIO()`_ 
...
`CreateStdIO()`_ `CreateExtIO()`_ `DeleteExtIO()`_ 
...
`intuition.library/NewObjectA() <./intuition#newobjecta>`_ `intuition.library/SetAttrsA() <./intuition#setattrsa>`_ `intuition.library/GetAttr() <./intuition#getattr>`_ `intuition.library/DisposeObject() <./intuition#disposeobject>`_ `CoerceMethodA()`_ `DoSuperMethodA()`_ `intuition/classusr.h </documentation/developers/headerfiles/intuition/classusr.h>`_ 
...
`intuition.library/NewObjectA() <./intuition#newobjecta>`_ `intuition.library/SetAttrsA() <./intuition#setattrsa>`_ `intuition.library/GetAttr() <./intuition#getattr>`_ `intuition.library/DisposeObject() <./intuition#disposeobject>`_ `DoMethodA()`_ `CoerceMethodA()`_ `intuition/classes.h </documentation/developers/headerfiles/intuition/classes.h>`_ 
...
`exec.library/RawDoFmt() <./exec#rawdofmt>`_ `locale.library/FormatString() <./locale#formatstring>`_ 
...
`intuition.library/NewObjectA() <./intuition#newobjecta>`_ `intuition.library/SetAttrsA() <./intuition#setattrsa>`_ `intuition.library/GetAttr() <./intuition#getattr>`_ `intuition.library/DisposeObject() <./intuition#disposeobject>`_ `DoMethodA()`_ `DoSuperMethodA()`_ "Basic Object-Oriented Programming System for Intuition" and the "boopsi Class Reference" documentation. 
...
`dos.library/GetSegListInfo() <./dos#getseglistinfo>`_ 
...
`exec.library/AllocMem() <./exec#allocmem>`_ exec.library/FreeMem(). 
...
`intuition.library/DisposeObject() <./intuition#disposeobject>`_ `intuition.library/SetAttrsA() <./intuition#setattrsa>`_ `intuition.library/GetAttr() <./intuition#getattr>`_ `intuition.library/MakeClass() <./intuition#makeclass>`_ "Basic Object-Oriented Programming System for Intuition" and "boopsi Class Reference" documentation. 
...
`NewObject()`_ `SetAttrs()`_ "Basic Object-Oriented Programming System for Intuition" and "boopsi Class Reference" documentation. 
...
`intuition.library/NewObjectA() <./intuition#newobjecta>`_ `intuition.library/DisposeObject() <./intuition#disposeobject>`_ `intuition.library/GetAttr() <./intuition#getattr>`_ `intuition.library/MakeClass() <./intuition#makeclass>`_ "Basic Object-Oriented Programming System for Intuition" and "boopsi Class Reference" documentation. 
