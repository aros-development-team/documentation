...
======================================= ======================================= ======================================= ======================================= 
`IEEESPAcos()`_                         `IEEESPAsin()`_                         `IEEESPAtan()`_                         `IEEESPCos()`_                          
`IEEESPCosh()`_                         `IEEESPExp()`_                          `IEEESPFieee()`_                        `IEEESPLog()`_                          
`IEEESPLog10()`_                        `IEEESPPow()`_                          `IEEESPSin()`_                          `IEEESPSincos()`_                       
`IEEESPSinh()`_                         `IEEESPSqrt()`_                         `IEEESPTan()`_                          `IEEESPTanh()`_                         
`IEEESPTieee()`_                        
======================================= ======================================= ======================================= ======================================= 
