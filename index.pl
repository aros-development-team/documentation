...
.. raw:: html
   ...
   Nocne buildy budowane są automatycznie każnej nocy z najnowszych źródeł. Aby wypróbować Live CD AROSa, ściągnij "boot ISO" dla twojej platformy.<br><br>
   ...
   <a href=https://archives.arosworld.org>Archiwa AROSa </a> zawierają najnowsze aplikacje, grafiki i dodatkową dokumentację przygotowaną przez społeczność AROS.<br><br>
   </td></tr></table>
   ...
   <a href=https://ae.amigalife.org>AROS-EXEC</a> jest głównym serwisem społeczności AROS. Odwiedź go jeśli szukasz pomocy lub chcesz sie dowiedzieć więcej o systemie AROS.<br><br>
   </td></tr></tbody></table>
   ...
   Kanały RSS:<br><img style="width: 177px; height: 2px;" alt="spacer" src="/images/sidespacer.png"><br>
   </td></tr></table>
   </td></tr></table>
