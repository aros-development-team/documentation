...
`Michal Schulz`__ ha compiuto il miracolo, e si apre un nuovo 
...
È nata una nuova distribuzione. `VmwAROS`__ è un sistema AROS 
...
tuttavia una `beta`__ iniziale è stata messa a disposizione di chiunque
...
i dati sul loro disco fisso. `Qui`__ trovate qualche 
informazione in più.
...
di AROS chiamata `Velocity`__. Presto dovrebbe rilasciarne una beta. 
